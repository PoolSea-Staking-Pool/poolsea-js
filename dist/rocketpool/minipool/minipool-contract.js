...
var MinipoolContract = function () {
    ...
    _createClass(MinipoolContract, [{
        ...
        key: "stake",
        value: function stake(validatorSignature, depositDataRoot, options, onConfirmation) {
            return (0, _transaction.handleConfirmations)(this.contract.methods.stake(validatorSignature, depositDataRoot).send(options), onConfirmation);
        }
        /**
